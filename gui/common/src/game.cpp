...
//     const ImVec2 sub = node.position - position;
...
// void GamePlay::update_nodes_positions(float board_unit, ImVec2 board_offset) {
//     for (std::size_t i = 0; i < nodes.size(); i++) {
//         nodes[i].position = ImVec2(
...
// void GamePlay::user_action(ImVec2 position) {
//     switch (phase) {
...
// void GamePlay::check_select_piece(ImVec2 position) {
//     for (std::size_t i = 0; i < nodes.size(); i++) {
...
// void GamePlay::check_place_piece(ImVec2 position) {
//     for (Node& node : nodes) {
//         if (!point_in_node(position, node)) {
//             continue;
//         }
...
// void GamePlay::check_move_piece(ImVec2 position) {
...
// void GamePlay::check_take_piece(ImVec2 position) {
